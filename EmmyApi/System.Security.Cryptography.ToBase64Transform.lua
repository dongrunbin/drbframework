...
---@public
---@return void
function ToBase64Transform:Clear() end
---@public
...
---@return number
function ToBase64Transform:TransformBlock(inputBuffer, inputOffset, inputCount, outputBuffer, outputOffset) end
---@public
---@param inputBuffer Byte[]
---@param inputOffset number
---@param inputCount number
---@return Byte[]
function ToBase64Transform:TransformFinalBlock(inputBuffer, inputOffset, inputCount) end
