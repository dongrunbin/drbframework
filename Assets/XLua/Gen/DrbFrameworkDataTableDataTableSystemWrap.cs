...
namespace XLua.CSObjectWrap
{
    ...
    public class DrbFrameworkDataTableDataTableSystemWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<DrbFramework.DataTable.IDataTableParser>(L, 2))
				{
					DrbFramework.DataTable.IDataTableParser _parser = (DrbFramework.DataTable.IDataTableParser)translator.GetObject(L, 2, typeof(DrbFramework.DataTable.IDataTableParser));
					
					DrbFramework.DataTable.DataTableSystem gen_ret = new DrbFramework.DataTable.DataTableSystem(_parser);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DrbFramework.DataTable.DataTableSystem constructor!");
