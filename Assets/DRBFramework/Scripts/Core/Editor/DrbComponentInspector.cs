...
namespace DrbFramework.Editor
{
    ...
    public class DrbComponentInspector : InspectorEditorBase
    {
        ...
        protected override void OnEnable()
        {
            ...
            m_ResourceHolderTypeNames = InitTypeName(m_ResourceHolderTypeName, typeof(Resource.IResourceHolder), ref m_ResourceHolderTypeNamesIndex);
            m_ResourceDecoderTypeNames = InitTypeName(m_ResourceDecoderTypeName, typeof(Resource.IResourceDecoder), ref m_ResourceDecoderTypeNamesIndex);
            m_DataTableParserTypeNames = InitTypeName(m_DataTableParserTypeName, typeof(DataTable.IDataTableParser), ref m_DataTableParserTypeNamesIndex);
            m_SettingHandlerTypeNames = InitTypeName(m_SettingHandlerTypeName, typeof(Setting.ISettingHandler), ref m_SettingHandlerTypeNamesIndex);
            m_UICreaterTypeNames = InitTypeName(m_UICreaterTypeName, typeof(UI.IUICreater), ref m_UICreaterTypeNamesIndex);
            m_LocalizationParserTypeNames = InitTypeName(m_LocalizationParserTypeName, typeof(Localization.ILocalizationParser), ref m_LocalizationTypeNamesIndex);
            m_DebugFormTypeNamesArr = InitTypeNames(m_DebugFormTypeNames, typeof(Debug.IDebugForm), ref m_DebugFormTypeNamesIndexes);
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            m_ResourceLoaderComponent.objectReferenceValue = EditorGUILayout.ObjectField("Resource Loader Component", m_ResourceLoaderComponent.objectReferenceValue, typeof(Resource.ResourceLoaderComponent), true);
            ...
            m_DownloaderComponent.objectReferenceValue = EditorGUILayout.ObjectField("Downloader Component", m_DownloaderComponent.objectReferenceValue, typeof(Download.DownloaderComponent), true);
            ...
            m_WebRequesterComponent.objectReferenceValue = EditorGUILayout.ObjectField("Http Requester Component", m_WebRequesterComponent.objectReferenceValue, typeof(Http.HttpRequesterComponent), true);
            EndModule();
            ...
            TypePopup("Setting Parser", ref m_SettingHandlerTypeNamesIndex, m_SettingHandlerTypeNames, m_SettingHandlerTypeName);
            EndModule();
