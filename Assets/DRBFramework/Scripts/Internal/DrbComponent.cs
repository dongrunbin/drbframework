...
namespace DrbFramework.Internal
{
    ...
    public class DrbComponent : MonoBehaviour
    {
        ...
        public static IAudioSystem AudioSystem { get; private set; }
        public static IEntitySystem EntitySystem { get; private set; }
        public static ISceneSystem SceneSystem { get; private set; }
